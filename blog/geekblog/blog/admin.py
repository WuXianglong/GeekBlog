...
from admin_tools import BaseModelAdmin
from admin_tools.sites import custom_site
from geek_blog.constants import ARTICLE_STATUS, COMMENT_STATUS
...
class ArticleAdmin(BaseModelAdmin):
    ...
    list_display = ('order', 'title', 'slug', 'category', 'status', 'enable_comment', 'display_tags',
                    'publish_date', 'modified_time', 'login_required', 'published', 'sync_status')
    list_display_links = ('title',)
    list_per_page = settings.ADMIN_LIST_PER_PAGE
