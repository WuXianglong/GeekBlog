...
class CustomForeignKeyRawIdWidget(ForeignKeyRawIdWidget):
    ...
    def render(self, name, value, attrs=None):
        ...
        if rel_to in self.admin_site._registry:
            ...
            related_url = reverse('admin:%s_%s_changelist' % (rel_to._meta.app_label, rel_to._meta.module_name), current_app=self.admin_site.name)
    ...
    def label_for_value(self, value):
        ...
        related_url = reverse('admin:%s_%s_changelist' % (self.rel.to._meta.app_label, self.rel.to._meta.module_name), current_app=self.admin_site.name)
        if value:
            try:
